...
public class AnimeRecyclerSearchAndGenreAdapterNew extends RecyclerView.Adapter<AnimeRecyclerSearchAndGenreAdapterNew.ViewHolder> {
    private Context context;
    private List<AnimeGenreAndSearchResultModel.AnimeSearchResultNew> searchResultList;

    public AnimeRecyclerSearchAndGenreAdapterNew(Context context, List<AnimeGenreAndSearchResultModel.AnimeSearchResultNew> searchResultList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemListBinding.textGenre.setText(searchResultList.get(position).getAnimeGenre());
